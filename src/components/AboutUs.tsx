...
export function AboutUs() {
  return (
    <div className="flex flex-col justify-center items-center gap-8 md:max-w-2xl max-w-xs">
      <BlurText
        text="ABOUT US"
        delay={100}
        animateBy="words"
        direction="bottom"
        onAnimationComplete={() => {}}
        className="text-4xl font-medium mb-1 font-playfair-display text-accent-dark"
      />
      <BlurText
        ...
        direction="bottom"
        onAnimationComplete={() => {}}
        className="md:text-md text-sm font-normal w-full text-accent-dark"
      />
    </div>
  );
}
